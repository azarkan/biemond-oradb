...
define oradb::client (
...
)
  {
    ...
    if ( $continue ) {
      ...
      $command = "/bin/sh -c 'unset DISPLAY;${download_dir}/client_${version}/${install_type}/runInstaller -silent -waitforcompletion -ignoreSysPrereqs -ignorePrereq -responseFile ${download_dir}/db_$
        {install_type}_${version}.rsp'"
