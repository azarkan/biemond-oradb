...
define oradb::installasm (
  Enum['11.2.0.4', '12.1.0.1', '12.1.0.2', '12.2.0.1', '18.0.0.0', '19.3.0.0'] $version = undef,
  String $file                                                                          = undef,
...
)
  {
    ...
    if ( $continue ) {
      ...
      if ( $zip_extract ) {
        ...
        if ( $version in ['12.2.0.1', '18.0.0.0','19.3.0.0']) {
          $file1 = "${file}.zip"
          $total_files = 1
        }
      ...
      if ($version in ['12.2.0.1', '18.0.0.0', '19.3.0.0']) {
        ...
        $command = "/bin/sh -c 'unset DISPLAY;cd ${grid_base};${download_dir}/${file_without_ext}/grid/runInstaller -silent -waitforcompletion -ignoreSysPrereqs -ignorePrereq -responseFile ${
          download_dir}/grid_install_${version}.rsp'"
      }
      ...
      if ( $version in ['12.2.0.1', '18.0.0.0', '19.3.0.0'] and $grid_type != 'CRS_SWONLY' ) {
      ...
      # cleanup
      if ( $zip_extract ) {
        if ($version != '12.2.0.1' and $version != '18.0.0.0' and $version != '19.3.0.0' ) {
