...
define oradb::installdb (
  Enum['11.2.0.1', '11.2.0.3', '11.2.0.4', '12.1.0.1', '12.1.0.2', '12.2.0.1', '18.0.0.0', '19.3.0.0'] $version = undef,
  String $file                                                                                                  = undef,
  ...
  Optional[String] $ee_optional_components                                                                      = undef,
...
)
  {
    ...
    if ( $version in ['18.0.0.0', '19.3.0.0']) {
    ...
    if ( $continue ) {
      ...
      if ($version in ['18.0.0.0', '19.3.0.0']) {
        ...
        $command = "/bin/sh -c 'unset DISPLAY;${download_dir}/${file}/database/runInstaller -silent -waitforcompletion -ignoreSysPrereqs -ignorePrereq -responseFile ${download_dir}/db_install_${
          version}_${title}.rsp'"
      }
